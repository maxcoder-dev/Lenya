...
opts = {
    ...
    'cmds': {
        ...
        'youtube': (
            ...
            'чекнуть ютубчик', 'ютубчик', 'youtube', 'открой youtube', 'гоу ютуб', 'гоу ютюб', 'го ютуб'
        ),
        'lichess': (
        ...
        'music': (
            'вруби музон', 'музыка', 'музон', 'go музон', 'врубай музон', 'давай музыку', 'музыку', 'вырубай музон', 'рубани музон'
        ),
        'github': (
        ...
        'zapros': (
            'гугл', 'google', 'найди', 'интернет', 'запрос', 'мой запрос', 'найди', 'найди в интернете', 'поиск', 'поиск в интернете'
        )
    }
}
...
bot_rand_replic_talk = [
    'У меня всё хорошо. Как я могу помочь тебе сегодня?',
    'У меня всё отлично, как всегда. Чем тебе помочь?',
    'У меня всё как обычно, скучаю на AMD Ryzen 5. Чем могу быть полезен?',
    'У меня всё как всегда... Вирусы, антивирусы, браузеры... А как у тебя?',
    'Всё хорошо. Сижу тут, жду команды.'
]
...
random_replic_search = [
    'Нашёл несколько источников. Вот пару из них:',
    'Вот два из нескольких источников, которые я нашел',
    'Я нашел несколько достоверных источников. Вот два достоверных ответа: '
]
